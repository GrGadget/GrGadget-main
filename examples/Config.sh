...
ASMTH=1.50                                   # sets the smoothing of the PM force and thus the split-scale between Tree/FMM force and PM force
#RCUT=3.0                                     # cut-off radius beyond which Tree or FMM evaluations are stopped in TreePM / FMM-PM
GR_CUT_DISTANCE=3.0
